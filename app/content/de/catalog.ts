  ...
  books: [
    {
      ...
      seriesSlug: "geist",
      description:
        "Sechs Studien, in denen Christoph Menke mit und gegen Hegel das Verhaeltnis von Autonomie, Freiheit und sozialer Befreiung neu bestimmt.",
      longDescription: [
        "Autonomia y liberacion fue als erster Band der Reihe Geist 1 fuer die spanischsprachige Edition vorbereitet und verbindet Hegel-Lektuere mit zeitgenoessischer Kritischer Theorie.",
        "Der Band richtet sich an Leserinnen und Leser der deutschen Philosophie, der Kritischen Theorie und der politischen Theorie und arbeitet zentrale Begriffe wie Freiheit, zweite Natur und Emanzipation systematisch aus.",
      ],
      quote: {
        source: "Resena editorial",
