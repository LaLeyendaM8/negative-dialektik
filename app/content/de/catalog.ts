  ...
  books: [
    {
      ...
      description:
        "Sechs Studien, in denen Christoph Menke mit und gegen Hegel das Verhaeltnis von Autonomie, Freiheit und Befreiung neu bestimmt.",
      longDescription: [
        "Autonomia y liberacion erscheint als erster Band der Reihe Geist 1 in spanischer Sprache und verbindet Hegel-Lektuere mit zeitgenoessischer Kritischer Theorie.",
        "Der Band richtet sich an Leserinnen und Leser der deutschen Philosophie, der Kritischen Theorie und der politischen Philosophie und entfaltet zentrale Begriffe wie Freiheit, zweite Natur und Emanzipation.",
      ],
      quote: {
        source: "",
        text:
      ...
      manualOrderNote:
        "Direkt ueber Negative Dialektik verfuegbar. Nationaler Versand inklusive. Geschaetzte Lieferzeit: 3-5 Werktage.",
